function [FinalClusters,FinalClusterIDs,NumTraceLim,MinDendriteLength,InitialClusterNum,Y]=mnl_EuclideanCrawler_Mag_Weighted_v3(Trace,EuThresh,dim,FigureDisplay,Y,MinPoints,MinLength)
%Function to create clusters based on the Euclidean Distances weighted by
%the norm mean magnitude of each trace. v2 has an improved plotting of the
%final figure
%
% Inputs
...
if strcmp(FigureDisplay,'y')==1
    ...
    mnl_ImagesOfClusters(Trace,dim,FinalClusters,ChosenClusters,0.75);
end
end
%% Subfunctions
