function [x,y]=mnl_BeeswarmPlots(data)
 % Adapted frim Jonas (2020). plot spread points (beeswarm plot) (https://www.mathworks.com/matlabcentral/fileexchange/37105-plot-spread-points-beeswarm-plot), MATLAB Central File Exchange. Retrieved October 26, 2020. 
 y=data;
 [~,x,y]=Jonas_plotSpread(data);
end

function [handles,x,y]=Jonas_plotSpread(varargin)
